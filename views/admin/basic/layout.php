...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/template/font-awesome.css'); ?>" />
<link rel="stylesheet" type="text/css" href="//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/datepicker3.css'); ?>" />
<link rel="stylesheet" type="text/css" href="<?php echo element('layout_skin_url', $layout); ?>/css/style.css?ver=1.0" />
<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/earlyaccess/nanumgothic.css" />
<?php if (element('favicon', $layout)) { ?><link rel="shortcut icon" type="image/x-icon" href="<?php echo element('favicon', $layout); ?>" /><?php } ?>

<!--
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/dist/css/AdminLTE.css'); ?>" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/dist/css/AdminLTE.min.css'); ?>" />
-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/css/custom.css?ver=1.0'); ?>" />
...
<!--
<script type="text/javascript" src="<?php echo base_url('assets/admin/common.js'); ?>"></script>
-->
...
<nav class="navbar navbar-inverse navbar-global navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">UPF 관리자 페이지</a>
        </div>
        <div class="navbar-minimalize" style="margin:10px;" ><a href="#" class="btn btn-primary btn-mini"><i class="fa fa-bars"></i></a></div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-user navbar-right">
            <li><a href="<?php echo site_url(); ?>"><span class="fa fa-home"></span> 홈페이지로 이동</a></li>
        ...
        <ul class="navbar-primary-menu">
            ...
            foreach (element('admin_page_menu', $layout) as $__akey => $__aval) {
                ...
                <li class="nav-first-level nav_menuname_<?php echo $__akey; ?> <?php echo (element('menu_dir1', $layout) === $__akey) ? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-second-level menu_collapse collapse <?php echo (element('menu_dir1', $layout) === $__akey) ? '' : ''; ?>" id="menu_collapse<?php echo $__akey; ?>" <?php echo (element('menu_dir1', $layout) === $__akey) ? '' : 'style="height:0;"'; ?>>
                        <?php
                        foreach (element('menu', $__aval) as $menukey => $menuvalue) {
                            ...
                            $all_keys = array_keys($this->mymenu[1]['menu'][element('menu_dir2', $layout)]);
                            $menu_dir3 = $this->mymenu[1]['menu'][element('menu_dir2', $layout)][$all_keys[0]][0];
                        ?>
                            
                            <li <?php echo(element('menu_dir1', $layout) === $__akey && (element('menu_dir2', $layout) === $menukey || element('menu_dir2', $layout).'/'.$menu_dir3 === $menukey) || element('menu_dir2', $layout)."?mem_auth=1" == $menukey || element('menu_dir2', $layout)."?mem_state=1" == $menukey ||  element('menu_dir2', $layout)."?mem_auth=1" == $menukey ||  element('menu_dir2', $layout)."?mem_all=1" == $menukey || element('menu_dir2', $layout).'/'.$menu_dir3."?mem_all=1" == $menukey) ? 'class="active"' : ''; ?>><a href="<?php echo admin_url($__akey . '/' . $menukey); ?>" <?php echo element(1, $menuvalue); ?> >-  <?php echo element(0, $menuvalue); ?>
                            </a></li>
                        <?php
                        } ?>
                    </ul>
    ...
    <div class="content_wrapper">
        ...
        <!-- end header -->
        <div class="contents">
            <?php echo element('menu_title', $layout) ? '<h3 style="display:none;">' . element('menu_title', $layout) . '</h3>' : ''; ?>
